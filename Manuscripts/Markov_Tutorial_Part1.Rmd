...
We describe how for constructing the previously published 4-state "Sick-Sicker" model to conduct a CEA of different strategies to illustrate the various aspects of cSTM implementation in R.[@Enns2015e;@Krijkamp2018] Figure \@ref(fig:STD-Sick-Sicker) represents the state-transition diagram of the Sick-Sicker model. 
