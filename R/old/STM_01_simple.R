...
# This is the simplified version of the base model (without transition rewards)
...
v_qaly_trt1_2 <- m_M_trt2 %*% v_u_trt1_2
## Vector of costs under New Treatment 1 & 2
v_cost_trt1_2 <- m_M_trt2 %*% v_c_trt1_2
